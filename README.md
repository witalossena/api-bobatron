Desenvolvimento de uma api em node.js para servir uma aplicação de react para a matéria de **PROJETO PRÁTICO DE SISTEMAS APLICADOS À NEGÓCIOS** da universidade nove de julho.
